...
dtm = DocumentTermMatrix(corpus, control = list(tokenize = bigram_tokenizer, weighting = function(x) weightBin(x)))
...
write.csv(main_data.bigram, "data/ngram/movie_review_bigram_TFBinary.csv", row.names = FALSE)
