#referensi: https://lailatussyarifah32.wordpress.com/2019/02/19/menguak-cara-explorasi-text-text-mining-dengan-package-tm-di-rstudi-statistics02/
...
write.csv(main_data.processed, "data/result/film_indonesia_processed.csv", row.names = FALSE)